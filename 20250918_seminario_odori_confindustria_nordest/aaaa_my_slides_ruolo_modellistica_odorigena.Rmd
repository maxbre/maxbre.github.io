---
title: '<br><br>.small[Meeting: "Le emissioni odorigene: come misurarle?"]<br><br>Modellistica di impatto odorigeno'
...
- Non esistono "LG ufficiali" sui contenuti tecnici di una valutazione modellistica odorigena di tipo "strategico" per produrre una classificazione "osmogena" del territorio.

- Dal punto di vista tecnico con la .red["modellistica inversa"]?
  
- Un argomento "nuovo" ed una metodica di valutazione da inventare, sviluppare e testare:  qualche "caso studio" interessante ma ancora in fase di sviluppo (ARPA-FVG).

.footnote[

La modellistica inversa (kernel deconvolution) produce un stima del .red["termine sorgente"]: per ogni cella del dominio di calcolo  viene stimata .red[l’emissione massima di odore [OUE/s] "consentita"] per il rispetto dei valori di accettabilità presso i recettori.
