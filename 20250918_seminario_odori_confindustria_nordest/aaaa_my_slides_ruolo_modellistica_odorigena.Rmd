...
Misura del .red[tono edonico] dell'odore cioè una .red[misura soggettiva] dell'accettabilità dell'odore (fattore chiave nella valutazione del disturbo o molestia odorigena).
...
- dello stato di benessere e/o di salute dei .red[recettori] (anche per eventuale contemporanea presenza di altre fonti di "pressione ambientale").
...
- .red[Intensity]: non viene valutato, solo "indirettamente" tramite la variabile *proxy*  .red[concentrazione odorigena] (diverso da intensità!).
...
- L'impiego di simulazioni modellistiche consente, dal flusso di odore emesso dalla sorgente, la .red[stima della concentrazione di odore ai recettori], in termini diagnostici (stato di fatto) e prognostici (stato di progetto o scenari alternativi).
...
- Principale caratteristica della modellistica odorigena è la difficoltà teorica e pratica (non superata) di ricostruire e valutare le .red[fluttuazioni delle concentrazioni], cioè i picchi di odore su pochi secondi che descrivono in modo più accurato e realistico l’.red[impatto presso i recettori].

- "Nuovi ed avanzati" approcci (CFD, trasporto varianza, pennacchio fluttuante, micromixing, a due particelle), ancora in fase di sviluppo e ricerca non hanno una diffusa traduzione "operativa" per varie motivazioni.

- Necessario concepire .red[un "metodo di stima" delle fluttuazioni a breve termine delle concentrazioni odorigene] oppure applicare un .red["fattore di correzione" (Peak-to-Mean ratio)] ai risultati delle stime su medie 1h (da approccio modellistico "classico")].

- L'approccio più utilizzato (semplice) è l'applicazione del fattore .red[*Peak-to-Mean Ratio*] alle stime delle medie 1h: soluzione pragmatica di tipo semi-empirico, ma non del tutto rigorosa!
...
- impatto recettori vicini sorgente <150 m: per PMR dinamico superiore di circa ordine di grandezza;
...
- richiesto impegno verso la *riproducibilità* per una valutazione di impatto *accurata e robusta*;
