...
- scegliere accuratamente input meteo (varie possibilità, non c'è una ricetta 'unica' e sempre valida!)

- considerare effetti dovuti a calma di vento (gaussiano!)
...
- definire molto attentamente parametri superficiali roughness, bowen ratio, albedo (*cfr. 'AERMOD implementation guide', p. 3.1.2*)
...
- confrontare i risultati rispetto a differenti approcci modellistici (è un ‘plus’ molto ‘dispendioso’ ma non sempre fattibile)
