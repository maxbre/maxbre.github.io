...
$H_c$ ca be thought of as the level in the stable atmosphere where the flow has sufficient kinetic energy to overcome the stratification and rise to the height of terrain.
---
## AERMOD - flagpole receptor heigth (refs)
...
$Z_r = receptor\ heigth\ (above\ stack\ base\ elevation)$
$Z_t = terrain\ heigth\ (above\ mean\ sea\ level)$ 

$Z_p$ .red[**is the 'receptor flagpole height' where concentration is calculated**]

 
**for any concentration calculation all heights are referred to stack base elevation (pay much attention!)**

in flat terrain $Z_t=0$ the concentration calculation is referring to the form of a single horizontal plume
