...
# define breaks
breaks <- c(0.002, 0.005, 0.01, 0.02, 0.06)

# define title
title <- " Scenario 3 - media annuale" 
...
ggsave('contour_sc3_avg.png', path='./img_pres/', width = 5, height = 5)

## ---- ggplot-f3-sc3-p98 ----

# file p98 avg 24h
fl <- './data_input/grd_f3_sc_3/Percentile_24h.grd'
...
ggsave('contour_sc3_p98.png', path='./img_pres/', width = 5, height = 5)

## ---- ggplot-f3-sc3-max ----

# file max avg 24h
fl <- './data_input/grd_f3_sc_3/Maximum_24h.grd'
...
ggsave('contour_sc3_max.png', path='./img_pres/', width = 5, height = 5)
