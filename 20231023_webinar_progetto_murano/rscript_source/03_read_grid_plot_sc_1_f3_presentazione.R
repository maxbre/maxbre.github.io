...
# define breaks
breaks <- c(0.1, 0.2, 0.5, 1, 3)

# define title
title <- " Scenario 1 - media annuale" 
...
ggsave('contour_sc1_avg.png', path='./img_pres/', width = 5, height = 5)

## ---- ggplot-f3-sc1-p98 ----

# file p98 avg 24h
fl <- './data_input/grd_f3_sc_1/Percentile_24h.grd'
...
ggsave('contour_sc1_p98.png', path='./img_pres/', width = 5, height = 5)

## ---- ggplot-f3-sc1-max ----

# file max avg 24h
fl <- './data_input/grd_f3_sc_1/Maximum_24h.grd'
...
# define xy extent
ll <- c(761250, 5037250)
xlim <- c(ll[1], ll[1]+2000)
ylim <- c(ll[2], ll[2]+2500)

# define breaks
breaks <- c(1, 2, 5, 10, 25)

# define title
title <- " Scenario 1 - max 24h" 
...
ggsave('contour_sc1_max.png', path='./img_pres/', width = 5, height = 5)
