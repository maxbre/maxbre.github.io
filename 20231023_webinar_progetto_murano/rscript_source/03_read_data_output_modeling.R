...
# compose two charts
fos_cal / fos_lap + plot_annotation(title = "Foscolo: Misura vs. CALPUFF vs. LAPMOD")
...
# compose two charts
mar_cal / mar_lap + plot_annotation(title = "Marco: Misura vs. CALPUFF vs. LAPMOD")
...
# compose two charts
ser_cal / ser_lap + plot_annotation(title = "Serenella: Misura vs. CALPUFF vs. LAPMOD")
