...
##### CALPUFF
fc <- './data_input/calpost_grid/rank(0)_cd_2952hr_conc_cd.grd'
...
###### LAPMOD
fl <- './data_input/lapost_grid/annual.grd'
...
c <- cp_avg %>% 
  ...
  geom_text_contour(aes(x = x, y = y, z = z ), 
                    ...
                    #binwidth = binwidth, 
                    breaks = seq(0.1, 0.6, 0.1),
                    stroke = 0.3, size = 2.5, skip = 0, show.legend = FALSE) +
...
ggsave('contour_calpuff_vs_lapmod_avg.png', path='./img_pres/', width = 6.5, height = 4.5)
