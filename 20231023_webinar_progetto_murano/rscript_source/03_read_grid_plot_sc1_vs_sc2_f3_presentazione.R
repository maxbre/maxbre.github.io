...
lp_avg %>%
  ...
  theme(panel.grid.major = element_line(linetype = 3),
        ...
        axis.text.y = element_text(vjust = 0.5, size=8)) -> sc1_avg
...
sc1_avg | sc2_avg + plot_layout(nrow = 1, widths = 1, heights = 1)

ggsave('contour_sc1_vs_sc2_avg.png', path='./img_pres/', width = 10, height = 5)
