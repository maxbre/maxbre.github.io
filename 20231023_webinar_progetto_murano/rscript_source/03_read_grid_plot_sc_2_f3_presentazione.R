...
ggsave('contour_sc2_avg.png', path='./img_pres/', width = 5, height = 5)
...
ggsave('contour_sc2_p98.png', path='./img_pres/', width = 5, height = 5)
...
ggsave('contour_sc2_max.png', path='./img_pres/', width = 5, height = 5)
