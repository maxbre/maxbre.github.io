...
Definizione di uno scenario *'altamente cautelativo'* che rispetto allo scenario *'base'* considera gli effetti dovuti a .red[‘building downwash’] (solo indirettamente in LAPMOD!) ed annullamento del .red[‘plume rise’].
...
- .red[*partendo dallo scenario di valutazione 'altamente cautelativo' (costruito a sua volta su uno scenario 'cautelativo'), le emissioni in ingresso al modello devono essere incrementate di circa 100 volte per  ottenere valori simulati (stime) paragonabili a quelli ambientali osservati (misure).*]
